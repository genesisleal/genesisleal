      ...
      <div className={`container ${styles.container}`}>
        <div className={styles.top}>
          <div className={styles.brand}>
            <span className={styles.brandName}>Genesis Leal</span>
          ...
          <div className={styles.social}>
            ...
            <a
              href="https://www.behance.net/LealGenesis"
              target="_blank"
              rel="noopener noreferrer"
              className={styles.socialLink}
              aria-label="Behance"
            ...
            <a
              href="https://github.com/genesisleal"
              target="_blank"
              rel="noopener noreferrer"
              className={styles.socialLink}
              aria-label="GitHub"
        ...
        <div className={styles.bottom}>
          <p className={styles.copyright}>
            &copy; {new Date().getFullYear()} Genesis Leal. Todos los derechos reservados.
          </p>
